...
class DatabaseHelper {
  ...
  final String columnThn_kelahiran = 'thnKelahiran';
  final String columnDescription = 'description';
  final String columnUsia = 'usia';
  final String columnTmp = 'tmp';
  final String columnIcon_url = 'iconUrl';
  ...
  Future<Database?> _initDB() async {
    ...
    String path = join(databasePath, 'kisah_nabi.db');
  ...
  //insert ke database
  Future<int?> saveData(Bookmark bookmark) async {
