...
class _BookmarkPageState extends State<BookmarkPage> {
  ...
  Future<void> getAllData() async {
    ...
    setState(() {
      ...
      listData!.forEach((data) {
        listBookmark.add(Bookmark.fromMap(data));
      });
    });
  }
            ...
            strCheckDatabase == 0
                ...
                : ListView.builder(
                     ...
                     itemBuilder: (context, index) {
                       Bookmark bookmark = listBookmark[index];
                                 ...
                                 child: Column(
                                   children: [
                                     ListTile(
                                       ...
                                       subtitle: Text(
                                         bookmark.thnKelahiran.toString(),
  ...
  Future<void> deleteData(Bookmark bookmark, int position) async {
